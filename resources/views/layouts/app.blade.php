                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <ul class=" list-unstyled list-group-item">
                                ...
                                @if(count(\App\Profile::where('user_id',\Auth::id())->get()) == 0)
                                <li> <a href="{{url('profile/create')}}"> <h4> File Your Profile </h4> </a></li><hr>
                                @else
                                    <li> <a href="{{url('profile/'.\Auth::id())}}"> <h4> My Profile </h4> </a></li><hr>
